...
// │  6  Proyecto — Pantalla de Topología de Red                      │
// └──────────────────────────────────────────────────────────────────┘
const int paso = 6;
...
// ─── Paso 2 — Column: TarjetaLog ─────────────────────────────────────────────
Widget _paso2() => Scaffold(
  body: ListView(
    children: [
...
// ─── Paso 3 — Row + Expanded + Spacer: FilaEstado ────────────────────────────────
Widget _paso3() => const Scaffold(
  body: Column(
    children: [
...
// ─── Paso 4 — Stack + Positioned: AvatarBadge ────────────────────────────────────────
Widget _paso4() => const Scaffold(
  body: Center(
    child: Wrap(
      spacing: 32,
      runSpacing: 24,
      ...
      children: [
        AvatarBadge(
          ...
          message: 'Servidor web principal',
        ),
        AvatarBadge(
          nombre: 'db-01',  
          alertas: 0,  
          ...
          message: 'Base de datos principal',
        ),
        AvatarBadge(
          nombre: 'worker', 
          alertas: 0,  
        ...
        AvatarBadge(
          ...
          alertas: 11, 
          activo: true,
          detalle: '10.0.0.20 · 12ms',
          message: '¡Máximas alertas!',
        ),
        AvatarBadge(
...
// ─── Paso 5 — SizedBox, Padding, Align, Wrap ────────────────────────────────────────
Widget _paso5() => Scaffold(
  body: ListView(
