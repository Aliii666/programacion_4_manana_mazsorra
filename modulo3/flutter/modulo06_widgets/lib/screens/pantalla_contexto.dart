...
class PantallaContexto extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: colores.secondaryContainer, // Ejercicio 3: Reemplazado primaryContainer por secondaryContainer
        ...
        children: [
          ...
          _Seccion(
            ...
            items: [
              ...
              'Padding Superior (Notch): ${MediaQuery.paddingOf(context).top.toStringAsFixed(0)} px', // Ejercicio 4: paddingOf notch
            ],
          ),
          ...
          // ── Acción con BuildContext ────────────────────────────
          ElevatedButton.icon(
            onPressed: () {
              // Ejercicio 6: Acceder a ScaffoldMessenger usando context
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: const Text('¡Hola! SnackBar mostrado usando BuildContext'),
                  backgroundColor: colores.secondary,
                  action: SnackBarAction(
                    label: 'Cerrar',
                    textColor: colores.onSecondary,
                    onPressed: () {},
                  ),
                ),
              );
