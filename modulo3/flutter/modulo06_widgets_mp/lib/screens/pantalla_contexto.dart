  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Pantalla Taller MP ${esMovil ? "movil" : "tablet"} - ${esRetrato ? "retrato" : "paisaje"}',
        ...
        children: [
          _Seccion(
            ...
            items: [
              ...
              'Padding Superior: ${MediaQuery.paddingOf(context).top.toStringAsFixed(0)} px',
            ],
          ),
          const SizedBox(height: 16),
          _Seccion(titulo: 'colorScheme', items: const []),
          Wrap(
          ...
          const SizedBox(height: 16),
          _Seccion(titulo: 'textTheme', items: const []),
          ...
          ElevatedButton.icon(
            onPressed: () {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: const Text('Notificacion Taller MP mostrada usando BuildContext'),
            ...
            label: const Text('Mostrar Notificacion MP'),
          ),
        ],
      ),
    );
